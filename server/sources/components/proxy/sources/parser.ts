...
export class Parser
{
	...
	private buildAliases() : void
	{
		...
		this.requestAliases.set(
			new RegExp(`${this.internalSourceRequest.protocol}://([a-zA-Z0-9\\-]*)\\.${this.internalSourceRequest.hostname}:${this.internalSourceRequest.port}`,'g'), 
		...
		this.requestAliases.set(
			new RegExp(`${this.internalSourceRequest.protocol}://${this.internalSourceRequest.hostname}:${this.internalSourceRequest.port}`,'g'), 
		...
		this.requestAliases.set(
			new RegExp(`${this.internalSourceRequest.hostname}:${this.internalSourceRequest.port}`,'g'), 
			`${this.internalTargetRequest.hostname}`
		)
	}
}